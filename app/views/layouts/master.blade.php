...
<html lang="hu">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ secure_asset('css/style_base.css') }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => secure_url('felhasznalo/uj-nev', $parameters = array()), 'id' => 'NameChangeForm')) }}
        ...
        <div class="container">
            <div class="row">
                <div class="hidden-xs hidden-sm col-md-4">
                    <a href="{{ URL::to('/'); }}" ><img src="{{ secure_asset('images/logo.png') }}" alt="FLK" id="logo" /></a>
                </div>
            ...
            <nav class="navbar navbar-default tmargin">
                ...
                <div class="collapse navbar-collapse" id="mainmenu">
                    <ul class="nav navbar-nav">
                        <li><a href="{{ URL::to('/hirek/'); }}">Hírek</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-expanded="false">Rólunk <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ URL::to('/rolunk/tortenet') }}">A Klub története</a></li>
                                <li><a href="{{ URL::to('/rolunk/edzesek') }}">Edzések</a></li>
                                <li><a href="{{ URL::to('/rolunk/arak') }}">Árak</a></li>
                                <li><a href="{{ URL::to('/rolunk/elerhetosegek') }}">Elérhetőségek</a></li>
                            </ul>
                        </li>
                        <li><a href="{{ URL::to('/albumok/') }}">Galéria</a></li>
                        <li><a href="{{ URL::to('/rekordok/') }}">Egyéni rekordok</a></li>
                            ...
                            @if(Auth::check())
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    @if(Session::has('member'))
                                        <li><a href="{{ URL::to('/rekordok/sajat') }}"><i class="fa fa-trophy fa-fw"></i> Saját eredményeim</a></li>
                                        <li><a href="{{ URL::to('/rekordok/uj') }}"><i class="fa fa-plus fa-fw"></i> Új eredmény feltöltése</a></li>
                                        <li class="nav-divider"></li>
                                    @endif
                                    @yield('membermenu')
                                    <li><a href="#" data-toggle="modal" data-target="#NameChange">Név megváltoztatása</a></li>
                                    <li><a href="{{URL::to('/logout')}}">Kijelentkezés</a></li>
                                </ul>
                            @else
                                <a href="{{ Facebook::getLoginUrl() }}"><i class="fa fa-facebook"></i> Facebook bejelentkezés</a>
                            @endif
                        </li>
                    </ul>
                </div>
            ...
            <div id="footer">
                <div class="row">
                    <div class="hidden-xs hidden-sm col-md-6">
                        <a href="http://www.fertorakos.hu" target="_blank"><img src="{{secure_asset('images/fertorakos.png')}}" alt="Fertőrákos"/></a>
                        <a href="http://www.mttosz.hu/" target="_blank"><img src="{{secure_asset('images/mttosz.png')}}" alt="MTTOSZ"/></a>
                    </div>
                    <div class="col-xs-12 col-md-6 text-right">
                        ...
                        <a href="https://github.com/fertorakosi-loveszklub/flk-honlap/" target="_blank">
                            Src
                        </a>
                        </p>
                    </div>
