                            ...
                            <tbody>
                                @foreach($category->records as $record)
                                    <tr>
                                        ...
                                        <td><a class="btn confirm" href="{{ URL::to('/rekordok/torles/' . $record->id) }}"><i class="fa fa-trash fa-fw"></i></a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ secure_asset('/js/jquery.tablesorter.min.js') }}"></script>
    <script type="text/javascript" src="{{ secure_asset('/js/myrecords.js') }}"></script>
@overwrite